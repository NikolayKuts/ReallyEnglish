...
public class DoubleNegativeActivity extends AppCompatActivity {
    ...
    public void onClickNextNegativeSentence(View view) {
        ...
        String[] arrayNegativeSentenceRu = getResources().getStringArray(R.array.negative_sentence_ru_qu);
        String[] arrayNegativeSentenceEn = getResources().getStringArray(R.array.negative_sentence_en_an);
